...
# ╔═╡ ca7f4536-7e24-41cf-9944-356ca5663a4c
sspdirs

# ╔═╡ 5f8c988c-4567-490c-bd0b-a16001cab48c
spoint
...
function plot_spectrum_for_point(sdfp, pt, fscale="cflt", escale="sumpes")
	plt = plot(sdfp[!, fscale], sdfp[!, escale], lw=2, label=pt, 
...
git-tree-sha1 = "d4c5540241eec2ee6a59a0ad9e4049e3ada4eba3"
