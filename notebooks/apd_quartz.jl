...
dsamples=Dict("CleanQUARTZ"=>(name="Quartz", dep="clean", c=0.0, Ba2=false, 
                               grass=false),
	"CleanQUARTZ_07072023"=>(name="Quartz", dep="clean", c=0.0, Ba2=false, 
                               grass=false)
)

# ╔═╡ 14192a57-c137-4a61-9074-98d6a0211ef9
dftpar=Dict(
	"Filter0"=>(nbins=100, dtmax=200.0, tmax=120.0, ymax=1.5*10^3, dymax=4*10^4, i0=[20,25, 50], l0=[25,55,100], dcut=100.0),
	"Filter1"=>(nbins=100, dtmax=200.0, tmax=120.0, ymax=2.5*10^2, dymax=2.5*10^3, i0=[20,23, 50], l0=[23,50,100], dcut=100.0),
	"Filter2"=>(nbins=100, dtmax=200.0, tmax=120.0, ymax=5*10^2, dymax=5*10^3, i0=[20,23, 50], l0=[23,33,100], dcut=100.0),
	"Filter3"=>(nbins=100, dtmax=200.0, tmax=120.0, ymax=5*10^2, dymax=1.5*10^4, i0=[20,23, 50], l0=[25,33,100], dcut=100.0),
	"Filter4"=>(nbins=100, dtmax=200.0, tmax=120.0, ymax=5*10^2, dymax=1*10^4, i0=[20,23, 50], l0=[23,33,100], dcut=100.0),
	"Filter5"=>(nbins=100, dtmax=200.0, tmax=120.0, ymax=10^3, dymax=1.0*10^4, i0=[20,23, 50], l0=[23,33,100], dcut=100.0),
	"Filter6"=>(nbins=100, dtmax=200.0, tmax=120.0, ymax=10^3, dymax=1.0*10^4, i0=[20,23, 50], l0=[23,33,100], dcut=100.0),
	"Filter7"=>(nbins=100, dtmax=200.0, tmax=120.0, ymax=10^3, dymax=1.6*10^4, i0=[20,23, 50], l0=[23,33,100], dcut=100.0),
	"Filter8"=>(nbins=100, dtmax=200.0, tmax=120.0, ymax=10^3, dymax=1.0*10^4, i0=[20,23, 50], l0=[23,33,100], dcut=100.0),
	"Filter9"=>(nbins=100, dtmax=200.0, tmax=120.0, ymax=10^3, dymax=1.0*10^4, i0=[20,23, 50], l0=[23,33,100], dcut=100.0),
	"Filter10"=>(nbins=100, dtmax=200.0, tmax=120.0, ymax=10^3, dymax=1.0*10^4, i0=[20,23, 50], l0=[23,33,100], dcut=100.0),
)
