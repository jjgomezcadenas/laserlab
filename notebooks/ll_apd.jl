...
# ╔═╡ f5c90393-faa4-47dc-a55b-9d66dd1d2c25
	dsamples=Dict("ZFFL19_QUIN1"=>(name="QUIN", dep="Spin-coated", c=1e-4, Ba2=false, 
								grass=true),
		"ZFFL19_QUIN2"=>(name="QUIN", dep="Spin-coated", c=1e-5, Ba2=false, 
								grass=true),
		"ZFFL19_QUIN4"=>(name="QUIN", dep="Spin-coated", c=1e-7, Ba2=false, 
								grass=true),
		"ZFFL20_A"=>(name="NAPH", dep="Spin-coated", c=1e-4, Ba2=false, 
								grass=false),
		"ZFFL21_B"=>(name="QUIN", dep="Spin-coated", c=1e-5, Ba2=false, 
								grass=false),
		"ZFFL21_C"=>(name="QUIN", dep="Spin-coated", c=1e-6, Ba2=false, 
								grass=false),
		"ZFFL21_D"=>(name="QUIN", dep="Spin-coated", c=1e-7, Ba2=false, 
								grass=false),
		"ZFFL21_E"=>(name="QUIN", dep="Spin-coated", c=1e-8, Ba2=false, 
								grass=false),
		"CleanQUARTZ"=>(name="Quartz", dep="clean", c=0.0, Ba2=false, 
								grass=false)
	)

	# ╔═╡ 14192a57-c137-4a61-9074-98d6a0211ef9
	dftpar=Dict("ZFFL19_QUIN1_Filter0"=>(nbins=244, dtmax=2000.0, tmax=60.0, ymax=1*10^3, dymax=5*10^3, i0=[6, 15, 25], l0=[14,25,244], dcut=100.0),
		"ZFFL19_QUIN2_Filter0"=>(nbins=244, dtmax=2000.0, tmax=120.0, ymax=5*10^3, dymax=3*10^4, i0=[6, 10, 10], l0=[10,244,244], dcut=100.0),
		"ZFFL19_QUIN4_Filter0"=>(nbins=244,dtmax=3000.0, tmax=120.0, ymax=10^3, dymax=2.5*10^4, i0=[4, 7, 20], l0=[6,20,244], dcut=100.0),
		"ZFFL20_A_Filter0"=>(nbins=100, dtmax=100.0, tmax=120.0, ymax=5*10^2, dymax=1*10^6, i0=[39,45, 45], l0=[42,55,55], dcut=50.0),
		"ZFFL21_B_Filter0"=>(nbins=100, dtmax=100.0, tmax=120.0, ymax=5*10^2, dymax=1*10^6, i0=[39,45, 45], l0=[42,55,55], dcut=50.0),
		"ZFFL21_C_Filter0"=>(nbins=100, dtmax=100.0, tmax=120.0, ymax=5*10^2, dymax=1*10^5, i0=[39,45, 45], l0=[42,55,55], dcut=50.0),
		"ZFFL21_D_Filter1"=>(nbins=50, dtmax=100.0, tmax=120.0, ymax=5*10^2, dymax=4*10^2, i0=[39,45, 45], l0=[42,55,55], dcut=50.0),
		"ZFFL21_E_Filter1"=>(nbins=100, dtmax=100.0, tmax=120.0, ymax=5*10^2, dymax=1*10^3, i0=[39,45, 45], l0=[42,55,55], dcut=50.0),
		"ZFFL21_D_Filter5"=>(nbins=100, dtmax=100.0, tmax=120.0, ymax=1*10^3, dymax=2*10^3, i0=[39,45, 45], l0=[42,75,100], dcut=50.0),
		"ZFFL21_E_Filter6"=>(nbins=100, dtmax=100.0, tmax=120.0, ymax=5*10^2, dymax=1*10^3, i0=[39,45, 45], l0=[42,100,100], dcut=50.0),
		"CleanQUARTZ_Filter0"=>(nbins=100, dtmax=200.0, tmax=120.0, ymax=5*10^2, dymax=2*10^4, i0=[20,24, 25], l0=[23,30,100], dcut=100.0),
		"CleanQUARTZ_Filter1"=>(nbins=100, dtmax=200.0, tmax=120.0, ymax=5*10^2, dymax=1*10^2, i0=[39,45, 45], l0=[42,55,55], dcut=100.0),
		"CleanQUARTZ_Filter2"=>(nbins=100, dtmax=200.0, tmax=120.0, ymax=5*10^2, dymax=5*10^2, i0=[39,45, 45], l0=[42,55,55], dcut=100.0),
		"CleanQUARTZ_Filter5"=>(nbins=100, dtmax=200.0, tmax=120.0, ymax=10^3, dymax=1.6*10^3, i0=[20,24, 30], l0=[23,28,100], dcut=100.0)
	)
...
pp =lfi.LaserLab.plot_h1dx(h1dtns; xs = "dt (ns)", ys = "a.u", 
						   ...
						   ylim=true, yl=(1,zdat.dymax), markersize=2, fwl=true)
...
# ╔═╡ 46c8b842-babf-4055-8208-e3105c2cbb72
histogram(pdf.dtime* ttrns)
...
# ╔═╡ d84dd3d8-7e0e-443b-bcd9-4611155008f6
